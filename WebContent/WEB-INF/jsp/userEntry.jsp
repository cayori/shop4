	...
	<form:form modelAttribute="user" method="post" action="userEntry.html">
		...
		<table>
			<tr height="40px">
				<td>유저ID</td>
				<td>
					<form:input path="userId" maxlength="20" cssClass="userId" />
					<font color="red">
			...
			<tr height="40px">
				<td>패스워드</td>
				<td>
					<form:password path="password" maxlength="20" cssClass="password" />
					<font color="red">
			...
			<tr height="40px">
				<td>이름</td>
				<td>
					<form:input path="userName" maxlength="20" cssClass="userName" />
					<font color="red">
			...
			<tr height="40px">
				<td>우편번호</td>
				<td>
					<form:input path="postCode" maxlength="8" cssClass="postCode" />
					<font color="red">
			...
			<tr height="40px">
				<td>주소</td>
				<td>
					<form:input path="address" maxlength="50" cssClass="address" />
					<font color="red">
